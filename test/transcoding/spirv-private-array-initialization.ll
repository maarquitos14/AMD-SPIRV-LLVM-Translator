...
;
; CHECK-SPIRV: Bitcast [[i32x3_ptr]] [[arr_i8_ptr:[0-9]+]] [[arr]]
; CHECK-SPIRV: CopyMemorySized [[arr_i8_ptr]] [[test_arr]] [[twelve]] 2 4
;
...
; CHECK-LLVM-DAG:call void @llvm.memcpy.p0.p2.i32(ptr align 4 %[[VAR2:.*]], ptr addrspace(2) align 4 @__const.test.arr2, i32 12, i1 false)
...
declare void @llvm.memcpy.p0.p2.i32(ptr captures(none) writeonly, ptr addrspace(2) captures(none) readonly, i32, i1) #1
